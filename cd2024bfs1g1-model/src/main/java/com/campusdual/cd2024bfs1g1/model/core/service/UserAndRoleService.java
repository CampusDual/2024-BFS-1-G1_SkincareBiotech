...
public class UserAndRoleService implements IUserAndRoleService {
	...
	@Override
	@Transactional(rollbackFor = Throwable.class)
	public EntityResult sellerRoleInsert(Map<String, Object> attributes)  {
		return this.insertUserWithRole(attributes,"seller");
	}
	...
	@Transactional(rollbackFor = Throwable.class)
	public EntityResult insertUserWithRole(Map<String, Object> attributes, String role)  {
